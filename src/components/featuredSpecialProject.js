...
export default function FeaturedSpecialProject({ description, title, slug, heroImage, heroVideo }) {
    ...
    return (
        <>
            ...
            <div ref={containerRef} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} className='p15 h-100vh flex flex-col'>
                ...
                <div className='flex-1 min-h-0 flex align-center justify-center'>
                    <div className={`pos-rel ratio-16-10 overflow radius-15 fit ${hovered ? "is-unblurred" : ""}`}>
