        ...
        <div className="p15">
            ...
            <div ref={rowRef} className='flex'>
                <div className='p15 flex-2'>
                    <div className='pos-rel ratio-16-10 radius-15'>{nextProject.image && <Image ref={imageRef} className='bg-image radius-15' src={nextProject.image} alt='' width={435} height={515} />}</div>
                    <p ref={titleRef} className='h3 p15'>{nextProject.title}</p>
                </div>
