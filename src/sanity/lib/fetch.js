...
export async function fetchInquire() {
    return client.fetch(INQUIRE_QUERY)
}

export async function fetchInquireOnly() {
    return client.fetch(INQUIRE_ONLY_QUERY)
}
