        ...
        .items([
            ...
            S.listItem()
                ...
                .child(
                    S.list()
                        .title("Modules")
                        .items([S.listItem().title("Headers").schemaType("header").child(S.documentTypeList("header").title("Headers")), S.listItem().title("Footers").schemaType("footer").child(S.documentTypeList("footer").title("Footers"))]),
                ),
